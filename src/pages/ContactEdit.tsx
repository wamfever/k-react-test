...
export const ContactsEdit = (): JSX.Element | null => {
    ...
    const decodeAvatar = (file: string) => {
    ...
    const submitFormHandler = async (data: Contact) => {
        ...
        await DexieDatabase.contacts.update(id as number, {
            name: data.name,
            phone: data.phone,
            email: data.email,
            gender: data.gender,
            ...
            <form onSubmit={handleSubmit(submitFormHandler)} className="mt-10 flex flex-col md:px-12">
                ...
                <div className="flex flex-wrap -mx-2">
                    <div className="w-1/2 px-2 flex flex-col">
                        <Select id="gender" selectDefault={gender} selectName="gender" label="Gender" register={register} />
                    </div>
                    <div className="w-1/2 px-2 flex flex-col">
                ...
                <Input type="file" accepEdit="image/*" id="avatar" name="avatar" label="Avatar" register={register} />
