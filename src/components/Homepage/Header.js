            ...
            <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
                <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        <h2 className="max-w-lg mb-2 font-sans text-center text-xl font-bold leading-none tracking-tight text-gray-900 md:mx-auto">
                            Hi and welcome to your own <span className="text-deep-purple-accent-400">personal agenda!</span>
                        </h2>
                        <p className="text-sm text-gray-700 px-0 sm:px-12 text-center">
