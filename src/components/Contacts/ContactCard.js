...
function ContactCard({ id, name, avatar, occupation }) {
    return (
        <div className="flex flex-col items-center justify-center h-[250px] p-5 text-center shadow-sm border rounded-xl w-full relative overflow-hidden">
            ...
            <Link to={`/k-react-test/contacts/details/${id}`} className="text-white bg-deep-purple-accent-400 mt-8 text-xs font-medium flex items-center absolute bottom-0 py-2 border-t w-full left-0 right-0 mx-auto justify-center">
                View Details
