...
function AddContactCard() {
    return (
        <Link to="/contacts/add" className="bg-white border shadow-sm flex items-center justify-center flex-col rounded-2xl flex-1 h-[250px] w-full transition-all cursor-pointer hover:scale-[1.02]">
